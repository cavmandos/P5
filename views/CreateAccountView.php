                    ...
                    Vos commentaires seront soumis à validation par nos modérateurs.</p>
                        <div class="my-5">
                            <form id="create-account">
                                ...
                                <div class="form-floating">
                                    <input class="form-control" id="username" type="text" placeholder="Entrez votre pseudo..." required/>
                                ...
                                <div class="form-floating">
                                    <input class="form-control" id="password" type="password" placeholder="Entrez votre mot de passe..." required />
                                    <label for="password">Mot de passe</label>
                                </div>
                                <div class="form-floating">
                                    <input class="form-control" id="confirm-password" type="confirm-password" placeholder="Confirmez votre mot de passe..." required />
